...
module.exports = function(grunt, options, spec) {
  return {
      ...
      sass: {
          ...
          scss: {
              files: {
                  [path.resolve(options.cacheDir, 'stylesheets/spectacle.css')]: path.resolve('doc_template', 'stylesheets/spectacle.scss')
              }
          },
          foundation_scss: {
              files: {
                  [path.resolve(options.cacheDir, 'stylesheets/foundation.css')]: path.resolve('doc_template', 'stylesheets/foundation-includes.scss')
              }
          },
      },
      ...
      'compile-handlebars': {
          compile: {
              files: [{
                  src:  'doc_template/views/' + (options.embeddable ? 'embedded.hbs' : 'main.hbs'),
