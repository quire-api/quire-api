...
public class UpdateOrganizationBody {
	@ApiModelProperty(
		value = "(Optional) OID of the users to replace the followers of this organization.\n"
		+ "Please refer to `addFollowers()` for more details.")
	public List<String> getFollowers() { return null; }
	@ApiModelProperty(
		value = "(Optional) OID of the followers to be added to this organization."
	...
	@ApiModelProperty(
		value = "(Optional) OID of the followers to be removed from this organization.\n"
		+ "Please refer to `addFollowers()` for more details.")
